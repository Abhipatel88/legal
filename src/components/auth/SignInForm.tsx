...
export default function SignInForm({ onSubmit, isLoading, error }: SignInFormProps) {
  ...
  return (
    <div className="flex flex-col flex-1 px-4 sm:px-0">
      ...
      <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto py-6 sm:py-0">
        <div>
          <div className="mb-6 sm:mb-8">
            <h1 className="mb-2 font-semibold text-gray-800 text-xl sm:text-2xl lg:text-3xl dark:text-white/90">
              Sign In
            </h1>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <Input
                    ...
                    className="h-11 w-full rounded-lg border bg-transparent px-4 py-2.5 text-sm shadow-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 border-gray-300 focus:border-primary focus:ring-primary/20 dark:border-gray-700 dark:text-white/90 dark:focus:border-primary"
                  />
                </div>
                <div>
                  <label className="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
